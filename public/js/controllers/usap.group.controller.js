(function ($) {
    $(function () {
        Controller.create("usap.groupCntrl",{
            events:{
                submit:
                    [
                        {target: "forum_form", handler: "grp_forum_submit_handler"},
                        {target: "post_form", handler: "grp_post_submit_handler"}
                    ],
                keyup:[
                    {target: "forum_usap_pod_wrapper", selector: "textarea", handler: "grp_forum_comment_post", type:"delegate"},
                    {target: "post_usap_pod_wrapper", selector: "textarea", handler: "grp_post_comment_post", type:"delegate"}
                ],
                click:[
                    {target:"forum_usap_pod_wrapper", selector: ".comment-num", handler:"grp_forum_comments_load", type:"delegate"},
                    {target:"forum_usap_pod_wrapper", selector: ".smiley", handler:"grp_forum_comment_smiley", type:"delegate"},
                    {target:"post_usap_pod_wrapper", selector: ".comment-num", handler:"grp_post_comment_load", type:"delegate"},
                    {target:"post_usap_pod_wrapper", selector: ".comments-cont-header .smiley", handler:"grp_post_smiley", type:"delegate"},
                    {target:"post_usap_pod_wrapper", selector: ".comment-pod-wrapper .smiley", handler:"grp_post_comment_smiley", type:"delegate"},
                    {target:"grp_join", handler:"grp_join_handler"}
                ]
            },
            shared:{
                methods:general,
            ...
            socket_start: function () {
                ...
                //Group forum socket
                this.grp_forum_sckt = this.GroupResource.groupForumSocket;
                this.grp_forum_sckt.start({
                ...
                //Group post socket
                this.grp_post_socket = this.GroupResource.groupPostSocket;
                this.grp_post_socket.start({
            ...
            forum_get: function (o) {
                /*alert(o.data);*/
                var packet = this.grp_forum_sckt.chck_data(o.data);
                if(packet && packet.packet_type == "grp_forum_load"){
                    this.grp_forum_sckt.fire("grp_forum_load_ev",packet);
                }else if(packet && packet.packet_type == "grp_forum_creation"){
                    this.grp_forum_sckt.fire("grp_forum_creation_ev",packet);
                }else if(packet && packet.packet_type == "grp_forum_comment_creation"){
                    this.grp_forum_sckt.fire("grp_forum_comment_creation_ev",packet);
                }else if(packet && packet.packet_type == "grp_forum_comment_load"){
                    this.grp_forum_sckt.fire("grp_forum_comment_load_ev",packet);
                }else if(packet && packet.packet_type == "grp_forum_comment_smiley_del"){
                    this.grp_forum_sckt.fire("grp_forum_comment_smiley_del_ev",packet);
                }else if(packet && packet.packet_type == "grp_forum_comment_smiley_creation"){
                    this.grp_forum_sckt.fire("grp_forum_comment_smiley_ev",packet);
                }
            ...
            forum_open: function (o) {
                this.grp_forum_sckt.post({"user_id":this.id, "group_id": this.group.id, "group_name": this.group.name});

                /*-------------------------------
                 * set group forum socket events
                 *-----------------------------*/
                this.grp_forum_sckt.bind("grp_forum_load_ev", $.proxy(this.grp_forum_load_handler,this));
                this.grp_forum_sckt.bind("grp_forum_creation_ev", $.proxy(this.grp_forum_creation_handler,this));
                this.grp_forum_sckt.bind("grp_forum_comment_creation_ev", $.proxy(this.grp_forum_comment_creation_handler,this));
                this.grp_forum_sckt.bind("grp_forum_comment_load_ev", $.proxy(this.grp_forum_comment_load_handler,this));
                this.grp_forum_sckt.bind("grp_forum_comment_smiley_del_ev", $.proxy(this.grp_forum_comment_smiley_del_handler,this));
                this.grp_forum_sckt.bind("grp_forum_comment_smiley_ev", $.proxy(this.grp_forum_comment_smiley_handler,this));
            },
            grp_forum_comment_smiley_del_handler: function (packet) {
                var smiley_data = packet.payload;
                //subtract from smiley number
                this.smiley_process(smiley_data,"subtract");
            },
            grp_forum_comment_smiley_handler: function (packet) {
                var smiley_data = packet.payload;
                //add to smiley number
                this.smiley_process(smiley_data);
            },
            grp_forum_load_handler: function (packet) {
                this.frm_spinner = false;
                Forum_mdl.display_mode = "append:top";
                Forum_mdl.populate(packet.payload);
            },
            grp_forum_creation_handler: function (packet) {
                Forum_mdl.display_mode = "append:top";
                Forum_mdl.populate(packet.payload);
            },
            grp_forum_comment_creation_handler: function (packet) {
            ...
            grp_forum_comment_load_handler: function (packet) {
            ...
            *--------------------------------*/
            post_get: function (o) {
                var packet = this.grp_post_socket.chck_data(o.data);
                if(packet.packet_type == "grp_post_load"){
                    this.grp_post_socket.fire("grp_post_load_ev",packet);
                }else if(packet.packet_type == "grp_post_creation"){
                    this.grp_post_socket.fire("grp_post_creation_ev",packet);
                }else if(packet.packet_type == "grp_post_smiley_creation"){
                    this.grp_post_socket.fire("grp_post_smiley_creation_ev",packet);
                }else if(packet.packet_type == "grp_post_smiley_del"){
                    this.grp_post_socket.fire("grp_post_smiley_del_ev",packet);
                }else if(packet.packet_type == "grp_post_comment_creation"){
                    this.grp_post_socket.fire("grp_post_comment_creation_ev",packet);
                }else if(packet.packet_type == "grp_post_comment_load"){
                    this.grp_post_socket.fire("grp_post_comment_load_ev",packet);
                }else if(packet.packet_type == "grp_post_comment_smiley_creation"){
                    this.grp_post_socket.fire("grp_post_comment_smiley_creation_ev",packet);
                }else if(packet.packet_type == "grp_post_comment_smiley_del"){
                    this.grp_post_socket.fire("grp_post_comment_smiley_del_ev",packet);
                }
            },
            ...
            post_open: function (o) {
                this.grp_post_socket.post({"user_id":this.id, "group_id": this.group.id, "group_name": this.group.name});

                /*----------------------------
                 * set grp_post_socket events
                 *--------------------------*/
                this.grp_post_socket.bind("grp_post_load_ev", $.proxy(this.grp_post_load_handler,this));
                this.grp_post_socket.bind("grp_post_creation_ev", $.proxy(this.grp_post_creation_handler,this));
                this.grp_post_socket.bind("grp_post_smiley_creation_ev", $.proxy(this.grp_post_smiley_creation_handler,this));
                this.grp_post_socket.bind("grp_post_smiley_del_ev", $.proxy(this.grp_post_smiley_del_handler,this));
                this.grp_post_socket.bind("grp_post_comment_creation_ev", $.proxy(this.grp_post_comment_creation_handler,this));
                this.grp_post_socket.bind("grp_post_comment_load_ev", $.proxy(this.grp_post_comment_load_handler,this));
                this.grp_post_socket.bind("grp_post_comment_smiley_creation_ev", $.proxy(this.grp_post_comment_smiley_creation_handler,this));
                this.grp_post_socket.bind("grp_post_comment_smiley_del_ev", $.proxy(this.grp_post_comment_smiley_del_handler,this));
            },
            grp_post_comment_smiley_del_handler: function (packet) {
                this.post_comment_smiley_process(packet.payload,"subtract");
            },
            grp_post_comment_smiley_creation_handler: function (packet) {
                this.post_comment_smiley_process(packet.payload);
            },
            grp_post_comment_load_handler: function (packet) {
                /*alert(JSON.stringify(packet));*/
                this.comment_render(packet.payload.post_magic_id,packet.payload.comments,"post",true,"top");
            },
            grp_post_comment_creation_handler: function (packet) {
            ...
            grp_post_smiley_creation_handler: function (packet) {
                this.post_smiley_process(packet.payload);
            },
            grp_post_smiley_del_handler: function (packet) {
                this.post_smiley_process(packet.payload,"subtract");
            },
            grp_post_creation_handler: function (packet) {
                /*alert(JSON.stringify(packet));*/
                if(this.grp_post_socket.loaded){//post have been loaded
            ...
            grp_post_load_handler: function (packet) {
                /*alert(JSON.stringify(packet));*/
                this.post_spinner = false;
                Post_mdl.display_mode = "append:bottom";
                Post_mdl.populate(packet.payload);
                this.grp_post_socket.loaded = true;
            },

            /*----------------------------
             * group forum event handlers
             *--------------------------*/
            grp_forum_submit_handler: function (e) {
            ...
            grp_forum_comment_post: function (e) {
                var that = e.data.that;
                if(e.keyCode == 13){
                    ...
                    if(!that.isEmpty(this)){
                        ...
                        that.grp_forum_sckt.post(socket_data);
            ...
            grp_forum_comments_load: function (e) {
            ...
            grp_forum_comment_smiley: function (e) {
                var that = e.data.that,
                    smiley_box = $(this);

                that.forum_comnt_smiley_engine(smiley_box,that,that.grp_forum_sckt);
            },
            ...
            *-------------------------*/
            post_pane_click: function (e) {
                ...
                if(!$(this).data("loaded")){
                    ...
                    that.grp_post_socket.post({type:"post_load", group_id: that.group.id});
                    $(this).data("loaded",true);
                }
            },
            grp_post_submit_handler: function (e) {
                try {
                    Post_form_mdl.records[0]['target'] = "group";
                    var that = e.data.that,
                        form = $(this),
                    ...
                    if (!that.isEmpty(form.find("textarea")) || file_present) {
                        ...
                        Post_form_mdl.records[0]['group_id'] = that.group.id;
                        ...
                        if (file_present) {//we have a file to deal with
                            ...
                            if(file_data.size <= 1000000 && file_data.type.search(/image.*/) >= 0){
                                ...
                                jQuery.ajax({
                                    ...
                                    success: function (o) {
                                        ...
                                        that.grp_post_socket.post(post_data, function () {
                            ...
                            //send the post data to the post socket
                            that.grp_post_socket.post(post_data);
            ...
            grp_post_comment_load: function (e) {
                if(!$(this).parents(".usap-pod").data("commentLoad")) {
                    var that = e.data.that,
            ...
            grp_post_smiley: function (e) {
                ...
                that.smiley_box_process(post_smiley_box,that.grp_post_socket,post_data,"post_smiley_del");
            },
            grp_post_comment_post: function (e) {
                var that = e.data.that;
                if(e.keyCode == 13){
                    if(!that.isEmpty(this)){
                        var socket_data = {},field = $(this),
                        ...
                        that.grp_post_socket.post(socket_data);
            ...
            grp_post_comment_smiley: function (e) {
                var that = e.data.that,
                    smiley_box = $(this),
                ...
                that.comment_smiley_box_process(smiley_box,that.grp_post_socket,post_data,"post_comment_smiley_del");
            }
        });//end of controller
    })
})(window.jQuery);
