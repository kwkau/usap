    ...
    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-default " >
            <div class="panel-heading">
                <div class="panel-title text-center adminfont">Administrator Registration</div>
            </div>

            <div class="panel-body2 login-margin" >

                <form id="reg-form" action="http://localhost/usap/dashboard/register" method="POST">

                    <div class="input-group">
                        <span class="input-group-addon glyphicon glyphicon-user"></span>
                        <input id="user" type="text" class="form-control" name="firstname" value="" placeholder="First Name"/>
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon glyphicon glyphicon-user"></span>
                        <input id="user" type="text" class="form-control" name="lastname" value="" placeholder="Last Name"/>
                    </div>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon glyphicon glyphicon-lock"></span>
                        <input id="password" type="password" class="form-control" name="password-hash" placeholder="Confirm Password"/>
                    </div>

                    <div class="form-group">
                        <div class="col-sm-12 controls">
                            <button type="submit" class="btn btn-primary btn-block"><i class="glyphicon glyphicon-log-in"></i> Register</button>
                        </div>
                    </div>
