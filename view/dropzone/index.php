<?= $this->htmlLink('dropzone.css', 'stylesheet') ?>
                        ...
                        <div class="create-form">
                            <form action="" method="post" data-sw-sync="Forum_form_mdl">
                                <div class="form-group">
                                    <textarea name="topic" class="form-control"
                                              placeholder="Type your forum topic...."></textarea>
                                </div>
...
<?= $this->htmlScript("controllers/ussap.dropzone.controller.js", "text/javascript") ?>
